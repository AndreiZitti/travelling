export type Country = {
  id: string; // ISO 3166-1 alpha-2 (e.g., "DE")
  name: string; // "Germany"
...
// Full list of countries with their continents
export const COUNTRIES: Country[] = [
  ...
  { id: "CD", name: "Congo (DRC)", continent: "Africa" },
  ...
  { id: "CY", name: "Cyprus", continent: "Europe" },
  ...
  { id: "KI", name: "Kiribati", continent: "Oceania" },
  ...
  { id: "TO", name: "Tonga", continent: "Oceania" },
